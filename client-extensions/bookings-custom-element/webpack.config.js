...
module.exports = {
	...
	externals: {
		...
		'@clayui/table': '@clayui/table',
		'@clayui/label': '@clayui/label',
		'@clayui/link': '@clayui/link',
		'@clayui/icon': '@clayui/icon',
		'@clayui/upper-toolbar': '@clayui/upper-toolbar',
		'@clayui/form': '@clayui/form',
		'@clayui/date-picker': '@clayui/date-picker',
		'@clayui/slider': '@clayui/slider',
